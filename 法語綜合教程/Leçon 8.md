...
|           |           singulier           |            pluriel           |
| :-------: | :---------------------------: | :--------------------------: |
| masculin  | mon père<br />ton père<br />son père  | mes parents<br />tes parents<br />ses parents |
...
1. 在否定句中，de代替直接賓語前的不定冠詞un, une, des，如：

        - Vous avez des frères ? - Non, je n'ai pas de frères.
        - Vous avez un manteau noir ? - Non, je n'ai pas de manteau noir.
...
2. 否定句中使用de要注意以下三點：
    ...
    3. de用於絕對否定的概念，如不是，就不用de：
            ...
            Je n'ai pas une question, j'ai beaucoup de questions.
            （= Je n'ai pas seulement une question. 不是絕對否定）



# Dialogue

(En classe de français, les étudiants parlent de leur famille. Voici les questions: D'où venez-vous ? De quelle ville êtes-vous ? Quel âge avez-vous ? Combien êtes-vous dans la famille ? Que font vos parents ? Comment sont vos parents ? etc. )
...
21. vieux, vieil, vieille&emsp;&emsp;adj. 年老的
        ...
        陽性單數：
            ...
            vieil（用於以元音或啞音h開始的單數名詞前） : un vieil ouvrier   un vieil homme
        陽性複數：
            vieux : des vieux films
        陰性單數：
...
25. une école&emsp;&emsp;學校
    ...
    école primaire/élémentaire  小學

    école secondaire (le collège初中, le lycée高中)  中學
